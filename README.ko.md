...
- `ai-apps`: Claude Desktop, ChatGPT 데스크톱 앱(Codex 포함, `codex-app`), Antigravity 2.0, Antigravity IDE.
...
| `enableMacosAppGroupAiApps` | `false` | ai-apps macOS App Group인 Claude Desktop, ChatGPT 데스크톱 앱(Codex 포함, `codex-app`), Antigravity 2.0, Antigravity IDE를 설치합니다. |
