...
assert_contains "$setup_output_text" "  Installs Claude Desktop, Codex desktop app (updates to the unified ChatGPT desktop app), Antigravity 2.0, and Antigravity IDE." "gum setup distinguishes the installed Codex app from its unified ChatGPT update"
...
assert_contains "$macos_status_output" "ai-apps                       : enabled (Claude Desktop, Codex desktop app (updates to the unified ChatGPT desktop app), Antigravity 2.0, and Antigravity IDE)" "Terrapod status distinguishes the installed Codex app from its unified ChatGPT update"
...
assert_contains "$dotted_status_output" "ai-apps                       : enabled (Claude Desktop, Codex desktop app (updates to the unified ChatGPT desktop app), Antigravity 2.0, and Antigravity IDE)" "Terrapod status reads root dotted data keys for the Codex app to unified ChatGPT update"
