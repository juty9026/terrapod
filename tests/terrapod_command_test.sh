...
assert_contains "$setup_output_text" "  Installs Claude Desktop, ChatGPT desktop app (with Codex), Antigravity 2.0, and Antigravity IDE." "gum setup describes the unified ChatGPT app under the ai-apps group name"
...
assert_contains "$macos_status_output" "ai-apps                       : enabled (Claude Desktop, ChatGPT desktop app (with Codex), Antigravity 2.0, and Antigravity IDE)" "Terrapod status reports the unified ChatGPT app in the enabled ai-apps macOS App Group"
...
assert_contains "$dotted_status_output" "ai-apps                       : enabled (Claude Desktop, ChatGPT desktop app (with Codex), Antigravity 2.0, and Antigravity IDE)" "Terrapod status reads root dotted data keys for the unified ChatGPT app in the ai-apps macOS App Group"
