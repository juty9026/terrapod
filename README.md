...
- `ai-apps`: Claude Desktop, ChatGPT desktop app (with Codex; `codex-app`), Antigravity 2.0, and Antigravity IDE.
...
| `enableMacosAppGroupAiApps` | `false` | Installs the ai-apps macOS App Group: Claude Desktop, ChatGPT desktop app (with Codex; `codex-app`), Antigravity 2.0, and Antigravity IDE. |
